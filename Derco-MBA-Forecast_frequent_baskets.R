...
original_datasource <- original_datasource %>% select(Year.Month.natural.Text,Material.Text,Invoice)
...
filename <- paste(c('Datasets/Derco_Forecast_Baskets.freq_', freq,'.csv'),collapse = '')
